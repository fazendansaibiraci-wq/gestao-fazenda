...
export function mensagemPeriodoNaoCadastrado(data: Date): string {
  ...
  return `Nenhum período de Safra/Entressafra cadastrado para o dia ${dataFormatada}. Cadastre esse período em Cadastros → Safras → aba Salários Safra / Entressafra antes de continuar.`
}
